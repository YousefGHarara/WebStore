          ...
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body" >
                  ...
                  <h2 class="mb-5"><?=$category->getNumOfRows()?></h2>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Stores <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5"><?=$store->getNumOfRows()?></h2>
                </div>
              </div>
            </div>
